...
#' @param tau The tau (or $\tau$) option allows researchers to specify the 'time delay',
#' which essentially sorts the data by the multiple $\tau$. This is done by specifying lagged embeddings
#' that take the form: t,t-1$\tau$,…,t-(E-1)$\tau$, where the default is tau(1) (i.e., typical lags). However, if
...
#' @param theta Theta (or $\theta$) is the distance weighting parameter for the
